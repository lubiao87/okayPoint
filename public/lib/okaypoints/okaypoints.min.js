...
{};a=[];g.numPoints=b.n;c(b,g.name,a);b={};b[g.name]=g;for(var d=g.pcoGeometry,e=0;e<a.length;e++){var f=a[e].name,h=a[e].numPoints,w=parseInt(f.charAt(f.length-1)),r=f.substring(0,f.length-1),v=b[r],t=f.length-1,x=N.createChildAABB(v.boundingBox,w),y=new z(f,d,x,g.scale,g.offset);y.level=t;y.numPoints=h;y.hasChildren=0<a[e].children;y.spacing=d.spacing/Math.pow(2,t);v.addChild(y);b[f]=y}g.loadPoints()}catch(Ja){u.numNodesLoading--,console.error('OkayPoints: Exception thrown parsing points.',Ja)}};
k.onerror=function(a){console.log('OkayPoints: Failed to load file! HTTP status '+k.status+', file:'+f,a)};k.send(null)}};z.prototype.getNumPoints=function(){return this.numPoints};z.prototype.dispose=function(){if(this.geometry&&null!=this.parent){this.geometry.dispose();this.geometry=null;this.loaded=!1;for(var a=0;a<this.oneTimeDisposeHandlers.length;a++)(0,this.oneTimeDisposeHandlers[a])();this.oneTimeDisposeHandlers=[]}};Object.assign(z.prototype,THREE.EventDispatcher.prototype);E.prototype.newerThan=
function(a){a=new E(a);return this.versionMajor>a.versionMajor||this.versionMajor===a.versionMajor&&this.versionMinor>a.versionMinor?!0:!1};E.prototype.equalOrHigher=function(a){a=new E(a);return this.versionMajor>a.versionMajor||this.versionMajor===a.versionMajor&&this.versionMinor>=a.versionMinor?!0:!1};E.prototype.upTo=function(a){return!this.newerThan(a)};class ta{constructor(a,b,c){this.version='string'===typeof a?new E(a):a;this.boundingBox=b;this.scale=c}load(a){if(!a.loaded){var b=this,c=
a.getURL(),e=new XMLHttpRequest;e.overrideMimeType('text/plain');e.open('GET',c,!0);e.responseType='arraybuffer';e.overrideMimeType('text/plain; charset=x-user-defined');e.onload=function(){try{b.parse(a,e.response)}catch(d){console.error('Potree: Exception thrown parsing points.',d),u.numNodesLoading--}};e.onerror=function(a){u.numNodesLoading--;console.error('Potree: Failed to load file.',e,c)};e.send(null)}}parse(a,b){var c=(new DataView(b,b.byteLength-4,4)).getUint32(0,!0),e=a.pcoGeometry.pointAttributes;
a.numPoints=c;c=a.boundingBox;var d=new THREE.Vector3;d=a.pcoGeometry.boundingBox.getCenter(d).sub(a.boundingBox.min);b={buffer:b,pointAttributes:e,version:this.version.version,schema:a.pcoGeometry.schema,min:[c.min.x,c.min.y,c.min.z],max:[c.max.x,c.max.y,c.max.z],offset:d.toArray(),scale:this.scale,normalize:a.pcoGeometry.normalize};u.workerPool.runTask(y.GREYHOUND,function(b){b=b.data;var c=b.attributeBuffers,d=new THREE.Box3((new THREE.Vector3).fromArray(b.tightBoundingBox.min),(new THREE.Vector3).fromArray(b.tightBoundingBox.max)),
e=new THREE.BufferGeometry,f;for(f in c){var m=c[f].buffer;parseInt(f)===x.POSITION_CARTESIAN?e.setAttribute('position',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(f)===x.COLOR_PACKED?e.setAttribute('color',new THREE.BufferAttribute(new Uint8Array(m),4,!0)):parseInt(f)===x.INTENSITY?e.setAttribute('intensity',new THREE.BufferAttribute(new Float32Array(m),1)):parseInt(f)===x.CLASSIFICATION?e.setAttribute('classification',new THREE.BufferAttribute(new Uint8Array(m),1)):parseInt(f)===
x.NORMAL_SPHEREMAPPED?e.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(f)===x.NORMAL_OCT16?e.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(f)===x.NORMAL?e.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(f)===x.INDICES?(m=new THREE.BufferAttribute(new Uint8Array(m),4),m.normalized=!0,e.setAttribute('indices',m)):parseInt(f)===x.SPACING&&(m=new THREE.BufferAttribute(new Float32Array(m),1),e.setAttribute('spacing',
...
if(void 0!==d.error)u.numNodesLoading--,console.error('Potree: Binary worker error.',d);else{var e=d.attributeBuffers,k=new THREE.Box3((new THREE.Vector3).fromArray(d.tightBoundingBox.min),(new THREE.Vector3).fromArray(d.tightBoundingBox.max)),h=new THREE.BufferGeometry,l;for(l in e){var m=e[l].buffer;parseInt(l)===x.POSITION_CARTESIAN?h.setAttribute('position',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.COLOR_PACKED?h.setAttribute('color',new THREE.BufferAttribute(new Uint8Array(m),
4,!0)):parseInt(l)===x.INTENSITY?h.setAttribute('intensity',new THREE.BufferAttribute(new Float32Array(m),1)):parseInt(l)===x.CLASSIFICATION?h.setAttribute('classification',new THREE.BufferAttribute(new Uint8Array(m),1)):parseInt(l)===x.NORMAL_SPHEREMAPPED?h.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.NORMAL_OCT16?h.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.NORMAL?h.setAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),
3)):parseInt(l)===x.INDICES?(m=new THREE.BufferAttribute(new Uint8Array(m),4),m.normalized=!0,h.setAttribute('indices',m)):parseInt(l)===x.SPACING&&(m=new THREE.BufferAttribute(new Float32Array(m),1),h.setAttribute('spacing',m))}k.max.sub(k.min);k.min.set(0,0,0);a.numPoints=b.data.buffer.byteLength/c.byteSize;a.geometry=h;a.mean=new THREE.Vector3(...d.mean);a.tightBoundingBox=k;a.loaded=!0;a.loading=!1;a.estimatedSpacing=d.estimatedSpacing;u.numNodesLoading--}},b,[b.buffer])}}var ka=[function(a){return{position:[a.getInt32(0,
...
!1;throw a;});throw a;})})}handle(a,b){}}class La{constructor(a){this.node=a}push(a){var b=this,c={buffer:a.arrayb,numPoints:a.pointsCount,pointSize:a.pointSize,pointFormatID:2,scale:a.scale,offset:a.offset,mins:a.mins,maxs:a.maxs},e=u.workerPool.getWorker(y.LAS_DECODER);e.onmessage=function(c){var d=new THREE.BufferGeometry,g=a.pointsCount,k=new Float32Array(c.data.position),h=new Uint8Array(c.data.color),l=new Float32Array(c.data.intensity),m=new Uint8Array(c.data.classification),p=new Uint8Array(c.data.returnNumber),
n=new Uint8Array(c.data.numberOfReturns),q=new Uint16Array(c.data.pointSourceID),w=new Uint8Array(c.data.indices);d.setAttribute('position',new THREE.BufferAttribute(k,3));d.setAttribute('color',new THREE.BufferAttribute(h,4,!0));d.setAttribute('intensity',new THREE.BufferAttribute(l,1));d.setAttribute('classification',new THREE.BufferAttribute(m,1));d.setAttribute('returnNumber',new THREE.BufferAttribute(p,1));d.setAttribute('numberOfReturns',new THREE.BufferAttribute(n,1));d.setAttribute('pointSourceID',
new THREE.BufferAttribute(q,1));d.setAttribute('indices',new THREE.BufferAttribute(w,4));d.attributes.indices.normalized=!0;k=new THREE.Box3((new THREE.Vector3).fromArray(c.data.tightBoundingBox.min),(new THREE.Vector3).fromArray(c.data.tightBoundingBox.max));d.boundingBox=b.node.boundingBox;b.node.tightBoundingBox=k;b.node.geometry=d;b.node.numPoints=g;b.node.loaded=!0;b.node.loading=!1;u.numNodesLoading--;b.node.mean=new THREE.Vector3(...c.data.mean);u.workerPool.returnWorker(y.LAS_DECODER,e)};
...
c.onreadystatechange=()=>{4===c.readyState&&(200===c.status?this.parse(a,c.response):console.log('Failed '+b+': '+c.status))};try{c.send(null)}catch(e){console.log('Failed request: '+e)}}}parse(a,b){var c=u.workerPool.getWorker(y.EPT_BINARY_DECODER);c.onmessage=function(b){var d=new THREE.BufferGeometry,e=b.data.numPoints,g=new Float32Array(b.data.position);d.setAttribute('position',new THREE.BufferAttribute(g,3));g=new Uint8Array(b.data.indices);d.setAttribute('indices',new THREE.BufferAttribute(g,
4));b.data.color&&(g=new Uint8Array(b.data.color),d.setAttribute('color',new THREE.BufferAttribute(g,4,!0)));b.data.intensity&&(g=new Float32Array(b.data.intensity),d.setAttribute('intensity',new THREE.BufferAttribute(g,1)));b.data.classification&&(g=new Uint8Array(b.data.classification),d.setAttribute('classification',new THREE.BufferAttribute(g,1)));b.data.returnNumber&&(g=new Uint8Array(b.data.returnNumber),d.setAttribute('returnNumber',new THREE.BufferAttribute(g,1)));b.data.numberOfReturns&&
(g=new Uint8Array(b.data.numberOfReturns),d.setAttribute('numberOfReturns',new THREE.BufferAttribute(g,1)));b.data.pointSourceId&&(g=new Uint16Array(b.data.pointSourceId),d.setAttribute('pointSourceID',new THREE.BufferAttribute(g,1)));d.attributes.indices.normalized=!0;g=new THREE.Box3((new THREE.Vector3).fromArray(b.data.tightBoundingBox.min),(new THREE.Vector3).fromArray(b.data.tightBoundingBox.max));a.doneLoading(d,g,e,new THREE.Vector3(...b.data.mean));u.workerPool.returnWorker(y.EPT_BINARY_DECODER,
...
!1).catch(a=>{console.log('Error reading LAZ:',a);if(c.isOpen)c.close().then(()=>{c.isOpen=!1;throw a;});else throw a;})}}class Ma{constructor(a){this.node=a}push(a){var b=u.workerPool.getWorker(y.EPT_LAS_ZIP_DECODER);b.onmessage=c=>{var d=new THREE.BufferGeometry,e=a.pointsCount,g=new Float32Array(c.data.position),k=new Uint8Array(c.data.color),h=new Float32Array(c.data.intensity),l=new Uint8Array(c.data.classification),m=new Uint8Array(c.data.returnNumber),p=new Uint8Array(c.data.numberOfReturns),
n=new Uint16Array(c.data.pointSourceID),q=new Uint8Array(c.data.indices);d.setAttribute('position',new THREE.BufferAttribute(g,3));d.setAttribute('color',new THREE.BufferAttribute(k,4,!0));d.setAttribute('intensity',new THREE.BufferAttribute(h,1));d.setAttribute('classification',new THREE.BufferAttribute(l,1));d.setAttribute('returnNumber',new THREE.BufferAttribute(m,1));d.setAttribute('numberOfReturns',new THREE.BufferAttribute(p,1));d.setAttribute('pointSourceID',new THREE.BufferAttribute(n,1));
d.setAttribute('indices',new THREE.BufferAttribute(q,4));d.attributes.indices.normalized=!0;g=new THREE.Box3((new THREE.Vector3).fromArray(c.data.tightBoundingBox.min),(new THREE.Vector3).fromArray(c.data.tightBoundingBox.max));this.node.doneLoading(d,g,e,new THREE.Vector3(...c.data.mean));u.workerPool.returnWorker(y.EPT_LAS_ZIP_DECODER,b)};var c={buffer:a.arrayb,numPoints:a.pointsCount,pointSize:a.pointSize,pointFormatID:a.pointsFormatId,scale:a.scale,offset:a.offset,mins:a.mins,maxs:a.maxs};b.postMessage(c,
...
new THREE.BufferGeometry;B.setAttribute('position',new THREE.BufferAttribute(k,3));B.setAttribute('color',new THREE.BufferAttribute(h,4,!0));B.setAttribute('intensity',new THREE.BufferAttribute(l,1));B.setAttribute('classification',new THREE.BufferAttribute(m,1));var D=new THREE.BufferAttribute(new Uint8Array(p),4,!0);B.setAttribute('indices',D);a.geometry=B;a.numPoints=f;a.loaded=!0;a.loading=!1;u.numNodesLoading--}catch(Oa){console.error('OkayPoints: Exception thrown parsing points.',Oa),u.numNodesLoading--}};
c.onerror=function(){u.numNodesLoading--;console.log('OkayPoints: Failed to load file, '+c.status+', file: '+b)};c.send(null)}}dispose(){if(this.geometry&&null!=this.parent){this.geometry.dispose();this.geometry=null;this.loaded=!1;for(var a=0;a<this.oneTimeDisposeHandlers.length;a++)(0,this.oneTimeDisposeHandlers[a])();this.oneTimeDisposeHandlers=[]}}getNumPoints(){return this.numPoints}}class ia extends THREE.EventDispatcher{constructor(){super();this.version=this.numPoints=0;this.boundingBox=null;
